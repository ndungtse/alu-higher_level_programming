#!/usr/bin/python3
"""Defines matrix_mul, which multiplies two matrices after validating them."""


def matrix_mul(m_a, m_b):
    """Return the matrix product of m_a and m_b.

    Both must be non-empty rectangular lists of lists of ints/floats whose
    inner dimensions are compatible for multiplication.
    """
